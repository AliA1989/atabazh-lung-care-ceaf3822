...
const PremiumPhoneMockup = ({ className = "" }: PremiumPhoneMockupProps) => {
  ...
  return (
    <div className={`relative h-[430px] w-full max-w-[760px] overflow-visible sm:h-[500px] md:h-[520px] lg:h-[485px] ${className}`}>
      <div className="absolute left-1/2 top-0 w-[860px] -translate-x-1/2 origin-top scale-[0.38] sm:scale-[0.52] md:scale-[0.7] lg:scale-[0.65]">
