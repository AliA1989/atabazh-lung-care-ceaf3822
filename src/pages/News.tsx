    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-5xl">
          <h2 className="text-3xl font-heading font-bold mb-8">Latest News</h2>
          
          <div className="space-y-8">
            <Card className="shadow-medium hover:shadow-lg transition-smooth">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 section-gradient">
        <div className="container mx-auto max-w-5xl">
          <h2 className="text-3xl font-heading font-bold mb-8">Educational Resources</h2>
        ...
        <div className="container mx-auto max-w-4xl">
          <Card className="shadow-medium">
            <CardContent className="p-12 text-center space-y-6">
              <h2 className="text-3xl font-heading font-bold">Media & Press Inquiries</h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 section-gradient">
        <div className="container mx-auto max-w-2xl text-center space-y-6">
          <h2 className="text-3xl font-heading font-bold">Stay Updated</h2>
          ...
          <Card className="shadow-soft">
            <CardContent className="p-8">
              <form className="flex flex-col sm:flex-row gap-4">
                ...
                />
                <Button type="submit" size="lg" className="hero-gradient border-0">
                  Subscribe
                </Button>
              </form>
