          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="aspect-square overflow-hidden" style={{
                border: "1px solid #e6e6e6",
                borderRadius: "10px",
                boxShadow: "0 2px 8px rgba(0, 0, 0, 0.06)"
              }}>
                  <img src="/lovable-uploads/clinical-icu-monitoring.png" alt="ICU patient receiving chest therapy with monitoring equipment" className="w-full h-full object-cover" />
                </div>
                ...
                boxShadow: "0 2px 8px rgba(0, 0, 0, 0.06)"
                  ...
                  <img src="/lovable-uploads/clinical-female-therapy.png" alt="Female patient receiving respiratory therapy" className="w-full h-full object-cover" />
                </div>
                ...
                boxShadow: "0 2px 8px rgba(0, 0, 0, 0.06)"
                  ...
                  <img src="/lovable-uploads/clinical-supine-therapy.png" alt="Supine patient receiving chest therapy" className="w-full h-full object-cover" />
                </div>
                ...
                boxShadow: "0 2px 8px rgba(0, 0, 0, 0.06)"
                  ...
                  <img alt="Seated patient receiving shoulder therapy" className="w-full h-full object-cover" src="/lovable-uploads/d1085550-1fd7-4426-a23c-d2f8b8d7324a.png" />
                </div>
              </div>
              {/* Footer Note */}
