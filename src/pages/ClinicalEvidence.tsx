    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-4xl md:text-5xl font-heading font-bold">Pilot Study Results</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <Card className="shadow-medium text-center">
              <CardContent className="p-8 space-y-4">
                <div className="w-20 h-20 mx-auto rounded-full hero-gradient flex items-center justify-center">
                  <TrendingDown className="h-10 w-10 text-primary-foreground" />
                </div>
                <div className="text-5xl font-heading font-bold text-primary">42%</div>
                <h3 className="text-xl font-heading font-semibold">Reduction in Hospital Transfers</h3>
            ...
            <Card className="shadow-medium text-center">
              <CardContent className="p-8 space-y-4">
                ...
                <div className="text-5xl font-heading font-bold text-primary">35%</div>
                <h3 className="text-xl font-heading font-semibold">Fewer Exacerbations</h3>
            ...
            <Card className="shadow-medium text-center">
              <CardContent className="p-8 space-y-4">
                ...
                <div className="text-5xl font-heading font-bold text-primary">75%</div>
                <h3 className="text-xl font-heading font-semibold">Time Savings</h3>
            ...
            <Card className="shadow-medium text-center">
              <CardContent className="p-8 space-y-4">
                ...
                <h3 className="text-xl font-heading font-semibold">Staff Satisfaction</h3>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 section-gradient">
        <div className="container mx-auto max-w-5xl">
          <h2 className="text-4xl font-heading font-bold text-center mb-12">Study Design & Methodology</h2>
          
          <Card className="shadow-medium mb-8">
            <CardContent className="p-8">
              <h3 className="text-2xl font-heading font-bold mb-4">Multi-Site Prospective Study</h3>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div>
                    <h4 className="font-heading font-semibold mb-2">Study Population</h4>
                  ...
                  <div>
                    <h4 className="font-heading font-semibold mb-2">Inclusion Criteria</h4>
                    <ul className="list-disc list-inside text-muted-foreground space-y-1">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-heading font-semibold mb-2">Study Protocol</h4>
                    <ul className="list-disc list-inside text-muted-foreground space-y-1">
                  ...
                  <div>
                    <h4 className="font-heading font-semibold mb-2">Data Collection</h4>
                    <ul className="list-disc list-inside text-muted-foreground space-y-1">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="shadow-soft">
              <CardContent className="p-6">
                <h3 className="text-xl font-heading font-bold mb-3">Primary Endpoints</h3>
            ...
            <Card className="shadow-soft">
              <CardContent className="p-6">
                <h3 className="text-xl font-heading font-bold mb-3">Secondary Endpoints</h3>
                <ul className="space-y-2 text-muted-foreground">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-5xl">
          <h2 className="text-4xl font-heading font-bold text-center mb-12">Detailed Findings</h2>
          
          <div className="space-y-8">
            <Card className="shadow-medium">
              <CardContent className="p-8">
                <h3 className="text-2xl font-heading font-bold mb-4">Hospital Transfer Reduction</h3>
                ...
                <div className="bg-secondary/30 p-6 rounded-lg">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-heading font-semibold mb-2">Treatment Group (n=78)</h4>
                      <p className="text-3xl font-heading font-bold text-primary">11 transfers</p>
                      <p className="text-sm text-muted-foreground">0.14 transfers per resident over 12 weeks</p>
                    </div>
                    <div>
                      <h4 className="font-heading font-semibold mb-2">Control Group (n=78)</h4>
                      <p className="text-3xl font-heading font-bold text-muted-foreground">19 transfers</p>
            ...
            <Card className="shadow-medium">
              <CardContent className="p-8">
                <h3 className="text-2xl font-heading font-bold mb-4">Respiratory Exacerbation Prevention</h3>
                <p className="text-lg text-muted-foreground mb-4">
            ...
            <Card className="shadow-medium">
              <CardContent className="p-8">
                <h3 className="text-2xl font-heading font-bold mb-4">Operational Efficiency</h3>
                <p className="text-lg text-muted-foreground mb-4">
                ...
                <div className="bg-secondary/30 p-6 rounded-lg">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-heading font-semibold mb-2">Smart Lung Physio™</h4>
                      <p className="text-3xl font-heading font-bold text-primary">5.2 min</p>
                      <p className="text-sm text-muted-foreground">Average session time including setup</p>
                    </div>
                    <div>
                      <h4 className="font-heading font-semibold mb-2">Manual Chest Physio</h4>
                      <p className="text-3xl font-heading font-bold text-muted-foreground">21.3 min</p>
            ...
            <Card className="shadow-medium">
              <CardContent className="p-8">
                <h3 className="text-2xl font-heading font-bold mb-4">Safety & Tolerability</h3>
                <p className="text-lg text-muted-foreground mb-4">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 section-gradient">
        <div className="container mx-auto max-w-5xl">
          <h2 className="text-4xl font-heading font-bold text-center mb-12">Publications & Presentations</h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-4xl text-center space-y-8">
          <h2 className="text-4xl md:text-5xl font-heading font-bold">Want to Learn More?</h2>
